...
class Tarefa:
    def __init__(self: Self,titulo_tarefa:str, data_conclusao: str = None, id_tarefa:
    int = None) -> None:
    ...
    def salvar_tarefa(self: Self) -> None:
        with Database('./data/tarefas.sqlite3')as db:
            query: str = "I NSERT INTO tarefas (titulo_tarefa, data_conclusao) VALUES (?, ?);"
